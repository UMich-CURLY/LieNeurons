...
class LNODEFunc(nn.Module):
    ...
    def __init__(self):
        ...
        self.net = nn.Sequential(
            LNLinearAndKillingRelu(1,10,algebra_type='so3'),
            # LNLinear(50,1)
            LNLinearAndKillingRelu(10,1,algebra_type='so3')
    ...
    def forward(self, t, y):
        # print(y.shape)
        y3 = rearrange(y**3,'b c d -> b c d 1')
        return rearrange(self.net(y3),'b c d 1 -> b c d')
