...
def main():
    ...
    parser.add_argument('--training_config', type=str,
                        default=os.path.dirname(os.path.abspath(__file__))+'/../config/sl3_equiv/training_param.yaml')
    ...
    # 5 input 
    training_set = sl3EquivDataSet5Input(config['train_data_path'], device=device)
